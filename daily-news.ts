...
function buildPageHtml(title: string, date: string, sections: Section[], navHtml = ''): string {
...
async function main() {
  ...
  // 1. Daily HTML
  const dailyHtml = buildPageHtml(`Daily News — ${today}`, today, sections, navHtml)
  ...
  console.log(chalk.bold.green(`✅ 完成！${totalNew} 条新内容`))
